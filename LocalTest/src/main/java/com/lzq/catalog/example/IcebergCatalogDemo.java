...
public class IcebergCatalogDemo {
    ...
    public void testRead(){
        ...
        String createSource = "CREATE TABLE IF NOT EXISTS iceberg_hive.luna.sink5 (\n" +
                "    order_id INTEGER COMMENT 'unique id',\n" +
                "          `order_date` DATE ,\n" +
                "          `order_time` TIMESTAMP(3),\n" +
                "          `quantity` INT ,\n" +
        ...
        String printSQL = "CREATE TABLE if not exists print_table1 (\n" +
                "    order_id INTEGER COMMENT 'unique id',\n" +
                "          `order_date` DATE ,\n" +
                "          `order_time` TIMESTAMP(3),\n" +
                "          `quantity` INT ,\n" +
        ...
        //String setInfo = "SET execution.type = streaming";
        String exeSql = "insert into print_table1 select * from iceberg_hive.luna.sink5 /*+ OPTIONS('streaming'='true', 'monitor-interval'='1s')*/";
        ...
        tableEnv.getConfig().getConfiguration().setString(PipelineOptions.NAME, "xc_job_read");
        tableEnv.getConfig().getConfiguration().setString("execution.type", "streaming");
        ...
        System.out.println("exe stmt read");


    }

    @Test
    public void testAlluxio(){
        String icebergCatalog = "CREATE CATALOG iceberg_alluxio WITH (\n" +
                "    'type'='iceberg',\n" +
                "    'catalog-type'='hive',\n" +
                "    'uri'='thrift://kudu3:9083',\n" +
                "    'clients'='2',\n" +
                "    'property-version'='1',\n" +
                "    'warehouse'='alluxio://flink01:19998/warehouse'\n" +
                ")";

        String createSource = "CREATE TABLE IF NOT EXISTS iceberg_alluxio.zdk.alluxio_table (\n" +
        ...
        String exeSql = "insert into print_table1 select * from iceberg_alluxio.zdk.alluxio_table";
        ...
        tableEnv.executeSql(icebergCatalog);
        String usecatalog = "use catalog iceberg_alluxio";
        //String createdb = "create DATABASE zdk";
    ...
    @Test
    public void testForS3(){
        /*String icebergCatalog = "CREATE CATALOG iceberg_s3 WITH (\n" +
                "    'type'='iceberg',\n" +
                "    'catalog-type'='hive',\n" +
                "    'uri'='thrift://kudu3:9083',\n" +
                "    'clients'='2',\n" +
        ...
        String usecatalog = "use catalog iceberg_s3";
        //String createdb = "create DATABASE iceberg_db_xc";

        String createSource = "CREATE TABLE IF NOT EXISTS iceberg_s3.iceberg_db_xc.xcods (\n" +
                "    id BIGINT COMMENT 'unique id',\n" +
                "    name STRING\n" +
                ")";

        String createPrintTable = "CREATE TABLE if not exists default_catalog.default_database.print_tablexc (\n" +
                " id bigint,\n" +
                " name STRING\n" +
                ") WITH (\n" +
                " 'connector' = 'print'\n" +
        ...
        String exeSql = "insert into default_catalog.default_database.print_tablexc select * from iceberg_s3.iceberg_db_xc.xcods";
        ...
        tableEnv.executeSql(icebergCatalog);
        tableEnv.executeSql(usecatalog);
        //tableEnv.executeSql(creatssedb);
        tableEnv.executeSql(createSource);
