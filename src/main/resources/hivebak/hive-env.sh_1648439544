...
export HIVE_METASTORE_HADOOP_OPTS=" -Xms2048m -Xmx2048m -XX:HeapDumpPath=./run -XX:+HeapDumpOnOutOfMemoryError  -XX:+ExitOnOutOfMemoryError -Xloggc:./logs/gc.log -XX:+UseGCLogFileRotation -XX:NumberOfGCLogFiles=5 -XX:GCLogFileSize=512M -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintHeapAtGC -XX:+PrintGCApplicationStoppedTime -XX:+PrintGCApplicationConcurrentTime -XX:-OmitStackTraceInFastThrow $HIVE_METASTORE_HADOOP_OPTS"
