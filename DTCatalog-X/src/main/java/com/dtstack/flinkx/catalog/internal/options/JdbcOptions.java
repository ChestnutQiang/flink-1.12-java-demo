...
public class JdbcOptions extends JdbcConnectionOptions {
    ...
    public static class Builder {
         ...
         * DTDialects#get} from DB url.
         */
        public Builder setDialect(DTDialect dialect) {
            this.dialect = dialect;
            return this;
        }
        ...
        public JdbcOptions build() {
            ...
            if (this.dialect == null) {
                Optional<DTDialect> optional = DTDialects.get(dbURL);
                this.dialect =
                        optional.orElseGet(
                                () -> {
