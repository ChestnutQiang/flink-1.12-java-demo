...
class TableJdbcUpsertOutputFormat
        extends JdbcBatchingOutputFormat<
                Tuple2<Boolean, Row>, Row, DTBatchStatementExecutor<Row>> {
    private static final Logger LOG = LoggerFactory.getLogger(TableJdbcUpsertOutputFormat.class);

    private DTBatchStatementExecutor<Row> deleteExecutor;
    ...
    private DTBatchStatementExecutor<Row> createDeleteExecutor() {
        int[] pkFields =
    ...
    private static DTBatchStatementExecutor<Row> createKeyedRowExecutor(
            int[] pkFields, int[] pkTypes, String sql) {
        return DTBatchStatementExecutor.keyed(
                sql,
    ...
    private static DTBatchStatementExecutor<Row> createUpsertRowExecutor(
