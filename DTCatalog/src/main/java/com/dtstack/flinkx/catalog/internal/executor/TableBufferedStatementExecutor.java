 ...
 */
public final class TableBufferedStatementExecutor implements DTBatchStatementExecutor<RowData> {

    private final DTBatchStatementExecutor<RowData> statementExecutor;
    private final Function<RowData, RowData> valueTransform;
    private final List<RowData> buffer = new ArrayList<>();

    public TableBufferedStatementExecutor(
            DTBatchStatementExecutor<RowData> statementExecutor,
