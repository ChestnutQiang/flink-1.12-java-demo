...
/**
 * {@link DTBatchStatementExecutor} that provides upsert semantics by updating row if it exists
 ...
 *     this once {@link JdbcUpsertTableSink} is removed.
 */
@Internal
public final class InsertOrUpdateDTExecutor<R, K, V> implements DTBatchStatementExecutor<R> {

    private static final Logger LOG = LoggerFactory.getLogger(InsertOrUpdateDTExecutor.class);
    ...
    public InsertOrUpdateDTExecutor(
