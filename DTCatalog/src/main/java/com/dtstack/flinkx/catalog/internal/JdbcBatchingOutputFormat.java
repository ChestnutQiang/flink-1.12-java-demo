...
public class JdbcBatchingOutputFormat<
                In, JdbcIn, JdbcExec extends DTBatchStatementExecutor<JdbcIn>>
    ...
    /**
     * A factory for creating {@link DTBatchStatementExecutor} instance.
     *
     * @param <T> The type of instance.
     */
    public interface StatementExecutorFactory<T extends DTBatchStatementExecutor<?>>
    ...
    public static class Builder {
         ...
         */
        public JdbcBatchingOutputFormat<Tuple2<Boolean, Row>, Row, DTBatchStatementExecutor<Row>>
                build() {
    ...
    static DTBatchStatementExecutor<Row> createSimpleRowExecutor(
