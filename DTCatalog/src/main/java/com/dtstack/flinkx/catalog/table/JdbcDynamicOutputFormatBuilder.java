...
public class JdbcDynamicOutputFormatBuilder implements Serializable {
    ...
    private static DTBatchStatementExecutor<RowData> createBufferReduceExecutor(
            JdbcDmlOptions opt,
            RuntimeContext ctx,
            TypeInformation<RowData> rowDataTypeInfo,
            LogicalType[] fieldTypes) {
        checkArgument(opt.getKeyFields().isPresent());
        DTDialect dialect = opt.getDialect();
    ...
    private static DTBatchStatementExecutor<RowData> createSimpleBufferedExecutor(
            RuntimeContext ctx,
            DTDialect dialect,
            String[] fieldNames,
            LogicalType[] fieldTypes,
    ...
    private static DTBatchStatementExecutor<RowData> createUpsertRowExecutor(
            DTDialect dialect,
            String tableName,
            String[] fieldNames,
            LogicalType[] fieldTypes,
    ...
    private static DTBatchStatementExecutor<RowData> createDeleteExecutor(
            DTDialect dialect, String tableName, String[] pkNames, LogicalType[] pkTypes) {
    ...
    private static DTBatchStatementExecutor<RowData> createSimpleRowExecutor(
            DTDialect dialect, String[] fieldNames, LogicalType[] fieldTypes, final String sql) {
    ...
    private static DTBatchStatementExecutor<RowData> createInsertOrUpdateExecutor(
            DTDialect dialect,
            String tableName,
            String[] fieldNames,
            LogicalType[] fieldTypes,
