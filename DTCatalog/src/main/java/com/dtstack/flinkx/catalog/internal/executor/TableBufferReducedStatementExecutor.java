...
public final class TableBufferReducedStatementExecutor
        implements DTBatchStatementExecutor<RowData> {

    private final DTBatchStatementExecutor<RowData> upsertExecutor;
    private final DTBatchStatementExecutor<RowData> deleteExecutor;
    ...
    public TableBufferReducedStatementExecutor(
            DTBatchStatementExecutor<RowData> upsertExecutor,
            DTBatchStatementExecutor<RowData> deleteExecutor,
