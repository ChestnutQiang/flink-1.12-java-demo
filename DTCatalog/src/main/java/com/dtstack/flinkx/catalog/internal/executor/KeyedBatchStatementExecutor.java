...
/**
 * A {@link DTBatchStatementExecutor} that extracts SQL keys from the supplied stream elements and
 * executes a SQL query for them.
 */
class KeyedBatchStatementExecutor<T, K> implements DTBatchStatementExecutor<T> {
